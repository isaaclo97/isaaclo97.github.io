---
title: "CodilityT3chfest2 — Codility"
summary: "Solución al problema CodilityT3chfest2 de Codility."
tags: ["Codility", "competitive-programming"]
categories: ["Programación Competitiva"]
type: page
---

## Solución — CodilityT3chfest2
...
string solution(string &S,string &T)
{
    ...
    else if((pueden(S,T)>1 && Cl!=Tl) || (pueden(S,T)>2 && Cl==Tl) || orden(S,T)>1) return "IMPOSSIBLE"; //se diferencian en ms de dos
    else{
