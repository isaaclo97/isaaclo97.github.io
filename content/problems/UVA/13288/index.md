...
int main() {
    ...
    while (scanf("%d %d", &numVine, &numCouriers) == 2) {
        ...
        for (int i = 0; i < numVine; i++) {
            ...
            ret += b; //incremento
            //Presupones que tendrs que hacer el trayecto botella->restaurante
            ...
            for (int j = 0; j < numVine-1; j++)
                ...
                //Aades esto numVinos-1 veces para asegurar que al menos un camino es
                //desde la casa de uno de los repartidores
                km.w[i][j+numCouriers] = -b;
        }
        //Segn este planteamiento una botella tiene que ser asignada o al restaurante(repartidor virtual) o a un repartidor.
        //Y al menos una botella ser repartida por un repartidor normal, ya que solo hay numBotellas-1 de los virtuales.
        ret += -km.match();
        printf("%d\n", ret);
    }
    return 0;
